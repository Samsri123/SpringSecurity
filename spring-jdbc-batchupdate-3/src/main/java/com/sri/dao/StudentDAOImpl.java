...
import com.sri.resultsetectractor.StudenrAddressResultSetExtractor;
...
public class StudentDAOImpl implements StudentDAO {
	...
	public Map<String, List<String>> groupStudentsByAddress() {
		String sql = "SELECT *FROM STUDENT";
		Map<String, List<String>> query = jdbcTemplate.query(sql, new StudenrAddressResultSetExtractor());
		return query;
	}
