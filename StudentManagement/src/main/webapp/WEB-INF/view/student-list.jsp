					...
					<tbody class="table">
						...
						<c:forEach var="student" items="${students}">
							<tr>
								...
								<td><a id="update-delete"
									href="updateStudent?userId=${student.id}"
									class="btn btn-success">Update</a></td>
								<td><a id="update-delete"
									href="deleteStudent?userId=${student.id}" onclick="if(!(confirm('Are you sure! you want ro delete this student'))) return false"
